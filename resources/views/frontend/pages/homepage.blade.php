<!DOCTYPE html><html lang="en"><head>
    <meta charset="utf-8">
    <meta name="title" content="Telemedicone">
    <!-- Responsive -->
 ...
 <!--End Preloader --> 
    ...
    <div class="page-wapper home-page-one">
       <header class="site-header" id="header-one">
                         ...
                         <div class="inner-sec">
                            ...
                            <div class="dropdown language-drp">
                              <button type="button" class=" btn-primary dropdown-toggle" data-toggle="dropdown">
                                <img src="{{asset('assets/images/language-1.jpg')}}" alt="lan"> Eng
                              </button>
                              <div class="dropdown-menu">
                               
                                <a class="dropdown-item" href="#"><img src="{{asset('assets/images/language-2.jpg')}}" alt="lan"> FRA</a>
                                <a class="dropdown-item" href="#"><img src="{{asset('assets/images/language-1.jpg')}}" alt="lan">GRE</a>
                              </div>
                            </div>
                         </div>
                      </div>
          ...
          <div class="navbar navbar-expand-lg bsnav bsnav-sticky bsnav-sticky-slide">
             <div class="container">
                <a class="navbar-brand" href="{{route('home')}}"><img src="{{asset('assets/images/default-logo.png')}}" class="img-fluid" alt="img"></a>
                ...
                <div class="collapse navbar-collapse">
                   ...
                   @if (Route::has('login'))
                   <ul class="navbar-nav navbar-mobile right-nav ml-auto " style="display: flex; gap: 1rem">
                     @auth
                     <li class="nav-item dropdown">
                       <a class="theme-btn float-right" href="{{route('dashboard')}}">Dashboard</a>
                       {{-- <button class="theme-btn float-right">Add to cart</button> --}}
                           {{-- <a class="theme-btn float-right" href="#"> Add to cart   </a> --}}
                           {{-- <ul class="navbar-nav submenu">
                             <li> <form action="#">
                        ...
                        @else 
                     <li class="nav-item dropdown">
                       <a class="theme-btn float-right" href="{{route('login')}}">Login</a>
                       {{-- <button class="theme-btn float-right">Add to cart</button> --}}
                           {{-- <a class="theme-btn float-right" href="#"> Add to cart   </a> --}}
                           {{-- <ul class="navbar-nav submenu">
                             <li> <form action="#">
                        ...
                        <li class="nav-item  dropdown cart_dropdown">
                          <a class="theme-btn float-right" style="background: rgb(16, 16, 16)" href="{{route('register')}}">Signup</a>
                              {{-- <a class="nav-link" href="#"> <span class="flaticon-supermarket head-icon"></span>   </a>
                              <ul class="navbar-nav submenu">
                               <li><div class="cart" id="cart_items">
                                  <div class="product_inside_cart">

                                  <div class="cart_in">
                                     <img src="{{asset('assets/images/view-product-1.jpg')}}" class="img-fluid" width="50" alt="proimg">
                                     <div class="content">
   ...
   <section class="main-slider">
    <div class="main-slider-carousel main-slider-one owl-carousel owl-theme">
       <div class="slide" style="background-image:url({{asset('assets/images/home-1-banner-1.jpg')}})">
          <div class="container text-left">
             <div class="content ">
                 <h1>GIVING CHILDREN<br>
                    <span>THE CARE THEY DESERVE</span></h1>
       ...
       <div class="slide" style="background-image:url({{asset('assets/images/home-1-banner-2.jpg')}})"> 
          <div class="container text-left">
                <div class="content ">
                      <h1>Advanced Medicine,<br>
                         <span>Trusted Care.</span></h1>
                      <div class="text">The bold mission of America’s MEDITEX Companies is to bring
                          an end to the burdens of disease, in all its forms.</div>
                      <div class="link-box">
                            <a href="#" class="theme-btn ">DEPARTMENTS</a>
       ...
       <div class="slide" style="background-image:url({{asset('assets/images/home-1-banner-3.jpg')}})"> 
          <div class="container text-left">
                <div class="content ">
                      <h1>Enhancing Life,<br>
                         <span>Excelling in Care.</span></h1>
                      <div class="text">The bold mission of America’s MEDITEX Companies is to bring
                          an end to the burdens of disease, in all its forms.</div>
                      <div class="link-box">
                          <a href="#" class="theme-btn ">DEPARTMENTS</a>
                            ...
                            @csrf
                               <div class="row clearfix">
                                  <div class="col-lg-6 col-md-6 col-sm-12">
                                     <div class="form-group">
                                        @if(Auth::user())
                                        <input type="text" name="name" value="{{Auth::user()->firstname}} {{Auth::user()->lastname}}" placeholder="Name*" required=""> 
                                        @else
                                  ...
                                  <div class="col-lg-6 col-md-6 col-sm-12">
                                     <div class="form-group">
                                        @if(Auth::user())
                                        <input type="text" name="phone" value="{{Auth::user()->contact}}" placeholder="Phone*" required=""> 
                                        @else
                                  ...
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                     <button class=" theme-btn" type="submit">BOOK YOUR APPOINTMENT NOW</button>
                                  </div>
                               </div>
...
<!---------welcomen-sec--------->
<section class="welcome_section hme-one" style="background:url(images/welcome-hme-1-bg.jpg')}})"> 
 <div class="container">
    ...
    <div class="row">
       <div class="col-lg-6">
          <div class="welcme_inner">
             ...
             <ul>
                <li><img src="{{asset('assets/images/awards-1.png')}}" class="img-fluid" alt="awards"></li>
                <li><img src="{{asset('assets/images/awards-2.png')}}" class="img-fluid" alt="awards"></li>
                <li><img src="{{asset('assets/images/awards-3.png')}}" class="img-fluid" alt="awards"></li>
                <li><img src="{{asset('assets/images/awards-4.png')}}" class="img-fluid" alt="awards"></li>
             </ul>
...
<section class="testimonial_sec hm-one">
    <div class="container">
          ...
          <div class="owl-carousel owl-theme two-item">
             ...
             <div class="testimonial_content">
                ...
                <div class="client_details">
                   <img src="{{asset('assets/images/test-1.png')}}" class="img-fluid" alt="test">
                   <div class="client_in">
                      <h6>Reta Schmidt</h6>
                      <span>Patient</span>
                   </div>
             ...
             <div class="testimonial_content">
                   ...
                   <div class="client_details">
                      <img src="{{asset('assets/images/test-2.png')}}" class="img-fluid" alt="test">
                      <div class="client_in">
          ...
          <div class="owl-carousel owl-theme client-carousel">
           ...
           <div class="item"><img src="{{asset('assets/images/client-hm-1.jpg')}}" class="img-fluid" alt="img"></div>
           <div class="item"><img src="{{asset('assets/images/client-hm-2.jpg')}}" class="img-fluid" alt="img"></div>
           <div class="item"><img src="{{asset('assets/images/client-hm-3.jpg')}}" class="img-fluid" alt="img"></div>
           <div class="item"><img src="{{asset('assets/images/client-hm-4.jpg')}}" class="img-fluid" alt="img"></div>
           <div class="item"><img src="{{asset('assets/images/client-hm-5.jpg')}}" class="img-fluid" alt="img"></div>
       ...
       <div class="col-lg-12">
          <div class="owl-carousel owl-theme three-item">
             ...
             <div class="best-doctor-outer">
                <div class="image">
                   <img src="{{asset('assets/images/best-doctors1.jpg')}}" class="img-fluid" alt="best-doctors">
               <a href="#" class="link"></a>
                </div>
                <div class="content-inner">
                   <h2> <a href="#">Dr. Genoveva Leannon </a> </h2>
                   <span>Internal Medicine</span>
                   <p>Dr. Will Marvin is an internist in Accra Ghana, and has been in practice between 5–10 years.</p>
                   <ul>
                      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                      <li><a href="#"><i class="fa fa-twitter"></i></a></li>
             ...
             <div class="best-doctor-outer">
                   <div class="image">
                      <img src="{{asset('assets/images/best-doctors2.jpg')}}" class="img-fluid" alt="best-doctors">
                      <a href="#" class="link"></a>
                   </div>
                   <div class="content-inner">
                      <h2><a href="#"> Dr. Bethany Kertzmann</a></h2>
                      <span>Anesthesiology</span>
                      <p>Dr. Bethany Kertzmann is an anesthesiologist in Accra, Ghana, and has been in practice between 3–5 years.</p>
                      <ul>
                         <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                         <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                         <li><a href="#"><i class="fa fa-skype"></i></a></li>
                ...
                <div class="best-doctor-outer">
                      <div class="image">
                         <img src="{{asset('assets/images/best-doctors3.jpg')}}" class="img-fluid" alt="best-doctors">
                         <a href="#" class="link"></a>
                      </div>
                      <div class="content-inner">
                         <h2><a href="#"> Dr. Danielle Bechtelar</a></h2>
                         <span>Cardiology</span>
                         <p>Dr. Danielle Bechtelar is a cardiologist in Accra, Ghana, and has been in practice between 5–10 years</p>
                         <ul>
                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-skype"></i></a></li>
                ...
                <div class="col-lg-6">
                   ...
                   <div class="articles-outer">
                      <div class="articles-inner">
                         <a href="#"><img src="{{asset('assets/images/articles-3-3.jpg')}}" class="img-fluid" alt="articles"></a>
                      ...
                      <div class="articles-inner">
                         <a href="#"><img src="{{asset('assets/images/articles-3-2.jpg')}}" class="img-fluid" alt="articles"></a>
                         <div class="articles-content">
                      ...
                      <div class="articles-inner">
                         <a href="#"> <img src="{{asset('assets/images/articles-3-1.jpg')}}" class="img-fluid" alt="articles"></a>
                         <div class="articles-content">
       ...
       <div class="container-fluid">
          ...
          <div class="map-outer">
             <div class="google-map" id="contact-google-map" data-map-lat="44.231172" data-map-lng="-76.485954" data-icon-path="assets/image/icons/map-marker.png')}}" data-map-title="Alabama, USA" data-map-zoom="12" data-markers="{
                " marker-1":="" [42.231172,="" -84.485954,="" "<h4="">Branch Office<p>4/99 Kumasi, Ashanti</p>"],
                "marker-2": [44.231172, -76.485954, "<h4>Branch Office</h4><p>4/99 Accra, Ghana</p>"],
                "marker-3": [40.880550, -78.393705, "<h4>Branch Office</h4><p>4/99 Capecoast, Ghana</p>"]
                }"&gt;
             </div>
          </div>
       </div>
 ...
 <div class="footer-last home-one">
    <div class="container">
       <div class="row clearfix">
          <div class="col-lg-12">
             <div class="left">
                <p>© 2024 <span>Ransboak.</span> All rights reserved.</p>
             </div>
             <div class="right">
                <ul>
    ...
    <script>
        $(document).ready(function() {
            ...
            function disableBookedDates(date) {
                var formattedDate = $.datepicker.formatDate('m/d/Y', date);

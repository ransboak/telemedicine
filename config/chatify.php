...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'Telemedicine'),
    ...
    |-------------------------------------
    */
    'storage_disk_name' => env('CHATIFY_STORAGE_DISK', 'chatify'),
    ...
    */
    'routes' => [
        ...
        'middleware' => env('CHATIFY_ROUTES_MIDDLEWARE', ['web','auth', 'doctor_patient', 'force.password.change', 'allow.chat']),

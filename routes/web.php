...
Route::middleware(['auth', 'force.password.change', 'doctor_patient'])->group(function(){
...
Route::middleware(['auth', 'force.password.change', 'doctor'])->group(function(){
...
Route::middleware(['auth', 'admin'])->group(function(){
    ...
    Route::post('/updateDoctor/{doctor}', [UserController::class, 'updateDoctor'])->name('update.doctor');
});
